...
namespace EFCORE.Persistence.Migrations
{
    ...
    [Migration("20250409071507_Initial-Database")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("EFCORE.Domain.Entities.Employee", b =>
                {
                    b.HasOne("EFCORE.Domain.Entities.Department", null)
                        .WithMany("Employees")
            ...
            modelBuilder.Entity("EFCORE.Domain.Entities.ProjectEmployee", b =>
                {
                    b.HasOne("EFCORE.Domain.Entities.Employee", null)
                        .WithMany("ProjectEmployees")
                        .HasForeignKey("EmployeeId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("EFCORE.Domain.Entities.Project", null)
                        .WithMany("ProjectEmployees")
            ...
            modelBuilder.Entity("EFCORE.Domain.Entities.Salary", b =>
                {
                    b.HasOne("EFCORE.Domain.Entities.Employee", "Employee")
                        .WithOne("Salary")
                        .HasForeignKey("EFCORE.Domain.Entities.Salary", "EmployeeId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
